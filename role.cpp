...
QVector<QString> Role::getRolePermissions() const
{
...
bool Role::hasPermission(const QString permStr) const
{
    ...
    {
        if (m_permissions.contains(permStr))
        {
            return true;
        }
        else
    ...
    {
        qDebug() << "Permissions container is empty";
        return false;
    }
}
