...
Pane {
    ...
    property string pageTitle: Js.capitalize(newRole) + " Editor"
    ...
    property bool editingSuccessful: false
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            Label {
                ...
                font.pixelSize: 14
                text: "Welcome to the " + newRole + " editing page. Here you'll be able to change your " + newRole + "'s phone number, "
                    + "email address and password. You can omit data you do not want to change."
                wrapMode: Label.Wrap
...
//                    text: (userManager.userExists(usernameTextField.text.toLowerCase())) ? "User already exists" : "Please enter three or more characters"
        ...
        Dialog {
            ...
            x: editingForm.x + 20
            y: editingForm.y + 20
            width: editingForm.width - 40
            height: editingForm.height - 40
            modal: true
            focus: true
            ...
            Rectangle {
                ...
                Label {
                    ...
                    width: parent.width
                    text: "A 4-digit account editing code is being sent"
                        + " to the provided phone number. Please enter it below"
                        + " to confirm a new account editing with Modio Burn."
                    wrapMode: Label.Wrap
                }
